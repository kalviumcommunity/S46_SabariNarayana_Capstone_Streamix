    ...
    <footer className="bg-black py-8">
      <div className="container mx-auto flex flex-col px-4 md:flex-row">
        <div className="mb-8 flex-1 md:mb-0">
          <div className="logo font-myFont text-6xl text-white">
            <a href="/">Streamix</a>
          </div>
          <p className="text-gray-400">
            Empowering YouTube creators and administrators to seamlessly
            collaborate, innovate, and elevate content creation.
          </p>
        </div>
